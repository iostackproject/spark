...
public class SwiftBlockOutputStream extends OutputStream {
  ...
  public SwiftBlockOutputStream(Configuration conf,
          ...
          throws IOException {
    LOG.info("CAMAMILLA BLOCK SwiftBlockOutputStream.constructor path = "+path);       // TODO TODO log
    this.conf = conf;
    this.store = store;
    this.path = path;
  ...
  private File newBackupFile() throws IOException {
    LOG.info("CAMAMILLA BLOCK SwiftBlockOutputStream.newBackupFile");       // TODO TODO log
  ...
  public long getPos() throws IOException {
    LOG.info("CAMAMILLA BLOCK SwiftBlockOutputStream.getPos pos = "+filePos);       // TODO TODO log
    return filePos;
  }

  @Override
  public synchronized void write(int b) throws IOException {
    LOG.info("CAMAMILLA BLOCK SwiftBlockOutputStream.write");       // TODO TODO log
    if (closed) {
  ...
  public synchronized void write(byte b[], int off, int len)
          throws IOException {
    LOG.info("CAMAMILLA BLOCK SwiftBlockOutputStream.write off = "+off+" len = "+len);       // TODO TODO log
    if (closed) {
      throw new IOException("Stream closed");
    }
    while (len > 0) {
  ...
  public synchronized void flush() throws IOException {
    LOG.info("CAMAMILLA BLOCK SwiftBlockOutputStream.flush");       // TODO TODO log
    if (closed) {
      throw new IOException("Stream closed");
    }
  ...
  private synchronized void flushData(int maxPos) throws IOException {
    LOG.info("CAMAMILLA BLOCK SwiftBlockOutputStream.flushData");       // TODO TODO log
  ...
  private synchronized void endBlock() throws IOException {
    LOG.info("CAMAMILLA BLOCK SwiftBlockOutputStream.endBlock");       // TODO TODO log
    //
  ...
  private synchronized void nextBlockOutputStream() throws IOException {
    LOG.info("CAMAMILLA BLOCK SwiftBlockOutputStream.nextBlockOutputStream");       // TODO TODO log
  ...
  private synchronized void internalClose() throws IOException {
    LOG.info("CAMAMILLA BLOCK SwiftBlockOutputStream.internalClose");       // TODO TODO log
  ...
  public synchronized void close() throws IOException {
    LOG.info("CAMAMILLA BLOCK SwiftBlockOutputStream.close");       // TODO TODO log
    if (closed) {
      return;
    }
