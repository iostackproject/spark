...
public class StrictBufferedFSInputStream extends BufferedFSInputStream {
  ...
  private static final Log LOG = LogFactory.getLog(StrictBufferedFSInputStream.class);
  ...
  public void seek(long pos) throws IOException {
    ...
    if (in == null) {
      LOG.info("CAMAMILLA StrictBufferedFSInputStream.seek to pos = "+pos+" ERROR");       // TODO TODO log
